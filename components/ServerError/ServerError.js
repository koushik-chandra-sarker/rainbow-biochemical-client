  ...
  return (
    <div
      ...
      <div
        ...
        <p className="text-7xl md:text-8xl tablet:text-9xl font-bold tracking-wider text-gray-300">{props.errorStatus}</p>
        <p className="text-4xl md:text-5xl tablet:text-6xl font-bold tracking-wider text-gray-300 mt-2">Server Error</p>
        <p className="text-tablet md:text-xl tablet:text-2xl text-gray-500 my-12">{props.error}</p>
      </div>
      <div className="w-1/2 tablet:h-full flex tablet:items-center justify-center p-4">
